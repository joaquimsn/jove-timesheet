...
public class DecimalConverter implements Converter {
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		...
		boolean hasPontoFlutuante = numeroReal.contains(",") 
				&& !(numeroReal.charAt(numeroReal.length() - 1) == '0' 
				&& numeroReal.charAt(numeroReal.length() - 2) == ',');
		
		if(hasPontoFlutuante) {
			...
			numeroReal = numeroReal.substring(0, numeroReal.indexOf(","));
